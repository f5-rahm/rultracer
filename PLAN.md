...
3. **Diff (capture-vs-capture)** — whole-A-vs-whole-B differential / side-by-side as in v0.5.0; *Load comparison…* now also lets you pick a saved on-box session; **Clear** drops comparison B. No TMM controls on the diff.
